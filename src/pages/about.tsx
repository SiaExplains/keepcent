  ...
  return (
    <div className="page-about">
      ...
      <div className="member">
        ...
        <p>
          I pay great attention to User Interface design, User Experience design and team work. I am
          a good learner and hard-working person. I constantly look for new ways to enhance my
      ...
      <div className="member">
        ...
        <p>
          ...
          multi-tasking skills and experience in team collaboration. I’d like to design & develop a
          part of the future.
        </p>
        <div className="tags">
